            ...
            <div className="article-card rounded-3xl">
              ...
              <div className="p-8">
                <div className="text-sm uppercase tracking-widest font-semibold block no-underline colors.coolGray-900">
                  ...
                  <p className="text-base m-0 card-para text-center">Rent anything you need for your next event. From event lighting to dance floors, tables & chairs and much more...</p>
                </div>
                <div className="rounded-md text-center mt-10">
                <Link to="/rentals">
                  <a
